// TypeGuards:
// typeof: Usado para determinar o tipo de uma variável.
// instanceof: Ele vai ver de fato se o objeto possui a função determinada anteriormente.
// in: Ela vai verificar se o objeto selecionada contêm as propriedades selecionadas.
...
function exibirTipo(a: alfanumerico, b: alfanumerico) {
  ...
  throw new Error(
    "Argumentos inválidos: Ambos os argumentos devem ser ou string ou number.",
  );
}

console.log(exibirTipo(10, 20));
console.log(exibirTipo("Olá ", "Mundo"));
//  console.log(exibirTipo(10, "Teste"))
...
mover(new Passaro("Passáro", "vermelho"));
